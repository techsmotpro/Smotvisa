    ...
    if (!office) {
        return (
            <div className="min-h-screen flex items-center justify-center pt-24">
                <div className="text-center p-8 bg-card rounded-3xl border border-border shadow-elevated">
                    <h2 className="text-3xl font-display font-bold mb-6 text-foreground">Office Not Found</h2>
                    <Link href="/contact" className="px-8 py-3 bg-secondary text-secondary-foreground font-display font-bold rounded-full shadow-gold hover:opacity-90 transition-all inline-flex items-center gap-2">
                            ...
                            <div className="space-y-10">
                                ...
                                {office.website && (
                                    <div className="flex items-start gap-5">
                                        ...
                                        <div>
                                            <p className="text-[10px] text-muted-foreground font-display font-bold uppercase tracking-[0.2em] mb-2">Digital Hub</p>
                                            <a href={`https://${office.website}`} target="_blank" rel="noopener noreferrer" className="text-base font-body font-bold text-secondary hover:underline transition-all">
                                                {office.website}
                                            </a>
                                        </div>
                                    </div>
