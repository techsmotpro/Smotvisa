                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, idx) => (
                            <motion.div
                                ...
                                className="bg-card rounded-2xl shadow-card border border-border p-8 hover:shadow-elevated transition-all group"
                            >
                    ...
                    <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
                        {destinations.map((destination, idx) => (
                            <motion.div
                                ...
                                className="px-6 py-4 bg-muted/50 rounded-2xl text-base font-body font-semibold text-foreground hover:bg-secondary hover:text-secondary-foreground transition-all cursor-default shadow-sm"
                            >
                                {destination}
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-muted/30">
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground font-body max-w-2xl mx-auto text-lg text-secondary">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {services.map((service, idx) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ delay: idx * 0.1 }}
                                className="bg-card rounded-2xl shadow-card border border-border p-6 text-center hover:translate-y-[-5px] transition-transform"
                            >
                        ...
                        <div className="space-y-4">
                            {faqs.map((faq, idx) => (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    transition={{ delay: idx * 0.1 }}
                                    className="bg-card rounded-2xl border border-border overflow-hidden hover:border-secondary/30 transition-colors shadow-sm"
                                >
