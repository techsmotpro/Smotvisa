...
export const visaData: Record<string, VisaInfo> = {
    us: {
        ...
        faqs: [
            ...
            { question: "How can SMOT VISA help me with my B1/B2 visa application?", answer: "At SMOT VISA, we assist Indian applicants with DS-160 form filling, document preparation, visa fee and appointment scheduling, mock interviews for confidence-building, and step-by-step support until your visa decision." }
        ]
    },
    uk: {
        id: "uk",
        ...
        description: "Planning a UK holiday or a business trip to London, Manchester, Birmingham, or anywhere in the United Kingdom? SMOT VISA makes your UK Tourist Visa and UK Business Visitor Visa process smooth, simple, and stress-free. We assist Indian travelers with complete document preparation, online application filing, biometrics support, and full guidance until your visa decision. With multiple branches across India, our experts ensure fast and error-free applications.",
    ...
    canada: {
        ...
        description: "Planning a holiday in Canada or traveling for business? SMOT VISA helps Indian travellers get their Canada Tourist Visa (Visitor Visa) and Business Visitor Visa with ease. With multiple branches across India and years of experience, we prepare your documents professionally, guide you through biometrics, and ensure a smooth, error-free application process. Whether you want to explore Toronto, Vancouver, Niagara Falls, or attend a business meeting, SMOT VISA makes your Canada journey simple and stress-free.",
    ...
    australia: {
        ...
        description: "Planning a holiday in Australia or traveling for a business meeting? SMOT VISA makes your Australia Tourist Visa and Business Visa process fast, simple and stress-free. With multiple branches across India, our visa experts help you prepare the right documents, avoid errors, and submit a complete application for the best chance of approval.",
    ...
    schengen: {
        ...
        faqs: [
            ...
            { question: "Can I apply Schengen visa online?", answer: "Yes. Schengen visa applications can be made online through the official portal of the relevant embassy or consulate. SMOT VISA assists with the entire online application process." },
            { question: "Where do I submit a Schengen visa application in India?", answer: "Applications must be made at the relevant embassy or authorised application centre (such as VFS Global or BLS International) in India. SMOT VISA guides you through the correct mission selection." },
            ...
            { question: "Who doesn't need to pay for a Schengen visa?", answer: "Children under 6 years of age, students and researchers, and certain other categories may be eligible for free or reduced-fee visas. SMOT VISA can help you determine if you qualify for any fee exemptions." },
