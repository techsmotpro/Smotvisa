                ...
                <div className="relative z-10 max-w-3xl mx-auto space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
                        <Link
                            ...
                            className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-secondary text-secondary-foreground font-display font-bold text-lg rounded-xl hover:translate-y-[-2px] transition-all shadow-gold group"
                        >
                        ...
                        {cta.secondaryCta && (
                            <Link
                                ...
                                className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-transparent border-2 border-white/20 text-white font-display font-bold text-lg rounded-xl hover:bg-white/10 transition-all group"
                            >
