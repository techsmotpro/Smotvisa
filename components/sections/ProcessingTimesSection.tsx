        ...
        <section id="processing-times" className="py-12 bg-muted/30">
            <div className="container mx-auto px-4">
                ...
                <MotionDiv
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="max-w-3xl mx-auto overflow-hidden rounded-xl border border-border shadow-card bg-card"
                >
                ...
                <p className="flex items-center justify-center gap-2 text-base font-body text-muted-foreground mt-8 max-w-2xl mx-auto text-center">
